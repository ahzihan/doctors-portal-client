        ...
        <div className='my-14 lg:my-28'>
            ...
            <div className="hero mt-12 lg:mt-28">
                <div className="hero-content flex-col lg:flex-row">
                    <img src={treatment} className="lg:max-w-sm rounded-lg shadow-2xl" alt="pic" />
                    <div className='lg:ml-28'>
                        <h1 className="text-3xl lg:text-3xl font-bold">Exceptional Dental Care, on Your Terms</h1>
